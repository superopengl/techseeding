...
import listAdminCompositePrompts from './routes/listAdminCompositePrompts.js';
import listAdminUsers from './routes/listAdminUsers.js';
import listAnalysisReports from './routes/listAnalysisReports.js';
import publishCompositePrompt from './routes/publishCompositePrompt.js';
...
export default async function server() {
  ...
  listAdminCompositePrompts(app);
  listAdminUsers(app);
  listAnalysisReports(app);
  publishCompositePrompt(app);
