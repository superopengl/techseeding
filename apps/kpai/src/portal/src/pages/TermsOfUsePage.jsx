        ...
        <div style={{ marginTop: 40 }}>
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              By accessing or using Lab4Kids ("the Platform"), operated by
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Lab4Kids is an AI-powered game making platform designed for children
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Access to Lab4Kids requires administrator approval. To request
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              When using Lab4Kids, you agree not to:
            </Paragraph>
            <ul style={{ color: "#4a5568", lineHeight: 2.2, paddingLeft: 24 }}>
              <li>
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Games and code created through Lab4Kids are generated by an AI
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              <strong>Platform:</strong> The Lab4Kids platform, its design,
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              ...
              using Lab4Kids are owned by the student (or their parent/guardian).
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Your use of Lab4Kids is also governed by our{" "}
              <a
                href="/privacy_policy"
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Lab4Kids is provided on an "as is" and "as available" basis. To the
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              ...
              Lab4Kids. Our total liability for any claim arising from the use of
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              We may suspend or terminate your access to Lab4Kids at any time,
