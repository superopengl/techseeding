        ...
        <div style={{ marginTop: 40 }}>
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              By accessing or using Code4Kids ("the Platform"), operated by
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Code4Kids is an AI-powered game making platform designed for children
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Access to Code4Kids requires administrator approval. To request
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              When using Code4Kids, you agree not to:
            </Paragraph>
            <ul style={{ color: "#4a5568", lineHeight: 2.2, paddingLeft: 24 }}>
              <li>
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Games and code created through Code4Kids are generated by an AI
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              <strong>Platform:</strong> The Code4Kids platform, its design,
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              ...
              using Code4Kids are owned by the student (or their parent/guardian).
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              Code4Kids is provided on an "as is" and "as available" basis. To the
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              ...
              Code4Kids. Our total liability for any claim arising from the use of
          ...
          <div style={section}>
            ...
            <Paragraph style={{ color: "#4a5568", lineHeight: 1.8 }}>
              We may suspend or terminate your access to Code4Kids at any time,
